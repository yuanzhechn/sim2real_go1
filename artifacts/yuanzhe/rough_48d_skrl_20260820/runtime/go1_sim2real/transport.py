...
class DryRunTransport:
    ...
    def read_state(self) -> RobotState:
        return RobotState(np.zeros(3), np.zeros(3), np.array([0, 0, -1], dtype=np.float32), self.default_joint_pos.copy(), np.zeros(12), self.last_action.copy(), timestamp=time.monotonic())
